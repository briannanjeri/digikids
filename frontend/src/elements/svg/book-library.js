...
const BookLibrary = () => {
  return (
    ...
    >
      ...
      <g>
        <path className="bookpath" d="M4.53,4.88H35.5v34h-29c-1.1,0-2-0.9-2-2V4.92C4.5,4.9,4.52,4.88,4.53,4.88z" />
        <path className="bookpath" d="M32.48,4.88V1.12H6.5c-1.1,0-2,0.9-2,2v1.77" />
